      ...
      <tr>
        <td valign="top" align="center">
          <table class="container" width="600" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 22px; color: #4C83EE; font-weight:bold">
                  Buzz<span style="color:rgb(251 146 60)">Chat</span>
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Thanks for choosing BuzzChat, We are happy to see you on board.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="font-size: 14px; line-height: 170%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          Best regards, <br><strong>BuzzChat</strong>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  ...
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">BuzzChat<br/>Texxesoft Services Centre  India PVT Ltd. 3rd Floor,Building #2 TexxeSoft Campus, Gachibowli Hyderabad - 500032</span>
                  </div>
                    </td></tr></table>     
                </td>
              </tr>
